...
export class Movement extends pc.ScriptType {
    ...
    public update(dt) {
        ...
        if(this.controlledByPlayer) {
            ...
            if (this.app.keyboard.isPressed(pc.KEY_LEFT)) this.horizontal = -1;
            if (this.app.keyboard.isPressed(pc.KEY_RIGHT)) this.horizontal += 1;
            if (this.app.keyboard.isPressed(pc.KEY_UP)) this.vertical = -1;
            if (this.app.keyboard.isPressed(pc.KEY_DOWN)) this.vertical += 1;
            if (this.app.keyboard.isPressed(pc.KEY_SPACE)) forceY += 0.2;
